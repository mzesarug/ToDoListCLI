...
print("reading writing to file test")
...
fileManager.writeListToFile("saveFile.txt", taskList.getTasks())

print("reading from file")
tasksFromFile = fileManager.readListFromFile("saveFile.txt")

for task in tasksFromFile:
    print(task)

print("clearing file")
fileManager.clearFile("saveFile.txt")
